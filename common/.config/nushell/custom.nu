...
source ./custom-completions/bitwarden-cli-completions.nu
source ./custom-completions/curl-completions.nu
source ./custom-completions/docker-completions.nu
source ./custom-completions/gh-completions.nu
source ./custom-completions/git-completions.nu
source ./custom-completions/make-completions.nu
source ./custom-completions/npm-completions.nu
source ./custom-completions/proto-completions.nu
